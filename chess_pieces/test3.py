...
kp1, des1 = extract_HOG(unseen_pawn_img, 0)

seen_pawn_img = cv2.imread('cropped_pictures/pawn/pawn20.png')
# kp2, des2 = siftdesc.detectAndCompute(seen_pawn_img, None)
kp2, des2 = extract_HOG(seen_pawn_img, 0)

unseen_king_img = cv2.imread('king.jpg')
# kp3, des3 = siftdesc.detectAndCompute(unseen_king_img, None)
kp3, des3 = extract_HOG(unseen_king_img, 0)

seen_king_img = cv2.imread('cropped_pictures/king/king20.png')
# kp4, des4 = siftdesc.detectAndCompute(seen_king_img, None)
kp4, des4 = extract_HOG(seen_king_img, 0)

#############

print "SVM"
clf_svm = joblib.load('classifiers_test/HOG/pawnVall_svm_classifier.pkl')
...
print "\n\nLR"
clf_lr = joblib.load('classifiers_test/HOG/pawnVall_lr_classifier.pkl')
print 'unseen_pawn_img'
...
print "\n\nKNN"
clf_knn = joblib.load('classifiers_test/HOG/pawnVall_knn_classifier.pkl')
print 'unseen_pawn_img'
