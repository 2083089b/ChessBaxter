...
clf_PKS = chess_train('descriptors/HOG', ['pawn', 'king', 'queen','knight','bishop','rock', 'square'], train_mod="LR")
# clf_PKS = chess_train('descriptors/HOG', ['pawn', 'king', 'square'], train_mod="LR")
# clf_QkS = chess_train('descriptors/HOG', ['queen', 'knight', 'square'], train_mod="LR")
# clf_BRS = chess_train('descriptors/HOG', ['bishop', 'rock', 'square'], train_mod="LR")
print "Training done!"
