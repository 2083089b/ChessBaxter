...
folders_names = ['white_pawn','white_king','white_knight','white_pawn','white_queen','white_rock'] # Missing the square

X = joblib.load('descriptors/white_bishop/white_bishop.pkl')
...
joblib.dump(clf,'classifiers/white_bishop_classifier.pkl')
